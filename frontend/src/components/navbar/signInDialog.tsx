  ...
  return (
    <DialogHeader className="flex flex-col items-center px-4 sm:px-6 md:px-8 py-6 space-y-4">
      <DialogTitle className="font-krona font-bold text-center leading-tight">
        ...
        <span className="block text-3xl sm:text-4xl md:text-5xl text-[#EE4035]">
          Pokeverse
        </span>
      </DialogTitle>

      <p className="text-center font-aclonica text-sm sm:text-base md:text-lg mb-6">
        Join the adventure!
      </p>

      <Button
        variant="outline"
        className="w-full max-w-xs py-2 px-4 flex items-center justify-center gap-2 text-sm sm:text-md font-semibold border-foreground hover:bg-gray-50"
